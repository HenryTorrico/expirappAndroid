...
import com.henry.tesis.expirapp.Expirapp.textDetector.TextGraphic;
...
public class GraphicOverlay extends View {
    ...
    public abstract static class Graphic {
        ...
        protected List<RectF> listaRectas = new LinkedList<RectF>();
        protected List<String> listaTextos= new LinkedList<String>();
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        if(event.getAction()==MotionEvent.ACTION_DOWN){
            for (Graphic graphic : graphics) {
                for(RectF rectF:graphic.listaRectas){
                    if(rectF.contains(x,y)) {
                        StillImageActivity activity=(StillImageActivity) getContext();
                        System.out.println("objeto " + activity.object);
                        textoFinal=graphic.listaTextos.get(graphic.cont);
                        Intent intent = new Intent(this.getContext(),NewProductActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        intent.putExtra("date",textoFinal);
                        intent.putExtra("objectDetected",activity.object);
